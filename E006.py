"""
▪ Write a program that gets four numbers as input from the
user
▪ The program should print out a positive encouragement if
one of these conditions are fullfilled and a negative
...
if no1==no2 and no3 == no4:
    print("you just used two numbers")
...
#shorter
print()
if (no1==no2 and no3 == no4) or (no1==no3 and no2 == no4) or (no1==no4 or no2 == no3):
    print("Task accomplished")
else:
    print("Conditions are not fullfilled")
